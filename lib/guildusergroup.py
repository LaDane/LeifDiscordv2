...
class GuildUserGroup:
    ...
    async def checkgroup(self, guild, member):
        return self.find_group(guild, member, ['Kompagni-Stab', '1. Del-Stab', '2. Del-Stab', '1-1', '1-2', '1-3', '2-1', '2-2', '2-3', 'Lima', 'Støt-Sek', 'Zeus', 'Prøve Medlem', 'Orlov', 'People', 'Date', 'Time'])
